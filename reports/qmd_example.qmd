...
We present the standard deviations in Table @tbl-level

Table @tbl-level. Standard deviation of historical (1906-1972) horse populations for each Canadian province.
...
Additionally, note that in Table @tbl-level we consider the sample standard deviation of the number of horses during the same time span as @fig-horseplot.
